      ...
      <div class="sidebar ">
        <ul class="navbar-nav">
         <li class="nav-item ">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="TeacherSalaries.jsp" id="">
            <i class="material-icons icon">
         people
          </i>
              <span class="text">Add Teacher Salary</span>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="GetTeacherSalaries.jsp" id="">
             <i class="material-icons icon">
         person_add
          </i>
              <span class="text">View Teacher Salary</span>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="PaySlip.jsp" id="">
             <i class="material-icons icon">
         receipt
          </i>
              <span class="text">PaySlip</span>
            </a>
          </li>
  </ul>
  </div>

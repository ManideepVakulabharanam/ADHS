...
/**
 * Servlet implementation class ClassSms
 */
@WebServlet("/ClassSms")
public class ClassSms extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "select MobileNumber from "+class_name+";";
			//String[] str = null;
			...
			request.setAttribute("result", "successfully sent");
				RequestDispatcher rsd = request.getRequestDispatcher("ClassSms.jsp");

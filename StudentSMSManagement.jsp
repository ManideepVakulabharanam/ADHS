      ...
      <div class="sidebar ">
        <ul class="navbar-nav">
         <li class="nav-item ">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="Classvisesms.jsp" id="">
            <i class="material-icons icon">
         chat
          </i>
              <span class="text">Classvise SMS</span>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="infosms.jsp" id="">
             <i class="material-icons icon">
         chat_bubble_outline
          </i>
              <span class="text">Holiday/info SMS</span>
            </a>
          </li>
           <li class="nav-item ">
            <a class="nav-link" href="SelectedSms.jsp" id="">
             <i class="material-icons icon">
         person
          </i>
              <span class="text">Selected SMS</span>
            </a>
          </li>

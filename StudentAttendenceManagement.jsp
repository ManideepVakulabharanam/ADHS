...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"  content="width=device-width, initial-scale=1">
...
<script type="text/javascript">
 $(document).ready(function(){
		 $("#dashboard").on("click", function(){
			 $(".contents").load("StudentDashboard.jsp");
		 })
	  });
  $(document).ready(function(){
      ...
      <div class="sidebar ">
        ...
        <li class="nav-item ">
         ...
         dashboard
          ...
          <li class="nav-item ">
            <a class="nav-link" href="StudentAttendence.jsp" id="ViewDet">
            <i class="material-icons icon">
         people
          </i>
          ...
          <li class="nav-item ">
            <a class="nav-link" href="Absent.jsp" id="AddStudent">
             <i class="material-icons icon">
         person
          </i>
              <span class="text">Absent Students</span>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="Sendsms.jsp" id="">
            <i class="material-icons icon">
         message
          </i>
